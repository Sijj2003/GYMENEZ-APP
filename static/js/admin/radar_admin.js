...
const toastHTML = `
<div id="radar-toast-admin" class="fixed top-6 right-6 z-[9999] transform translate-x-[150%] transition-transform duration-500 flex items-center gap-3 bg-[#060608]/95 backdrop-blur-xl border border-sky-500/30 p-3 pr-6 rounded-2xl shadow-[0_10px_40px_rgba(14,165,233,0.2)] cursor-pointer hover:bg-white/5 hover:scale-105" onclick="window.location.href='/apps/admin/pulse.html'">
